# ![LOGO](logo.png) Cloud Speech-to-Text **flow**ground Connector

## Description

A generated **flow**ground connector for the Cloud Speech-to-Text API (version v1).

Generated from: https://api.apis.guru/v2/specs/googleapis.com/speech/v1/swagger.json<br/>
Generated at: 2019-05-07T17:42:01+03:00
...
### Performs asynchronous speech recognition: receive results via the<br/>
> google.longrunning.Operations interface. Returns either an<br/>
> `Operation.error` or an `Operation.response` which contains<br/>
...
### Performs synchronous speech recognition: receive results after all audio<br/>
...
**flow**ground :- Telekom iPaaS / googleapis-com-speech-connector<br/>
